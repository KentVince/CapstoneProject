    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <table class="info-table">
                ...
                <tr>
                    <td>Name</td>
                    <td>{{ $farmer->firstname }} {{ $farmer->middlename }} {{ $farmer->lastname }}</td>
                </tr>
                <tr>
                    <td>Crop</td>
                    <td>{{ $farmer->crop ?? 'Coffee' }}</td>
                </tr>
            </table>
            ...
            <div class="highlight">
                ...
                @if($qrCodePath)
                    <div class="qr-container">
                        <img src="{{ $message->embed($qrCodePath) }}" alt="QR Code for {{ $farmer->app_no }}">
                    </div>
                @endif

                <p>Application No: <strong>{{ $farmer->app_no }}</strong></p>
