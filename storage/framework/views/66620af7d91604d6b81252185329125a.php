...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Dear <strong><?php echo e($professional->firstname); ?> <?php echo e($professional->lastname); ?></strong>,</p>

            <p>Your account as an <strong>Agricultural Professional</strong> has been successfully registered in the CofSys system. Below are your account details:</p>

            <table class="info-table">
                <tr>
                    <td>Application No.</td>
                    <td><strong><?php echo e($professional->app_no); ?></strong></td>
                </tr>
                <tr>
                    <td>Name</td>
                    <td><?php echo e($professional->firstname); ?> <?php echo e($professional->middlename); ?> <?php echo e($professional->lastname); ?></td>
                </tr>
                <tr>
                    <td>Agency</td>
                    <td><?php echo e($professional->agency); ?></td>
                </tr>
            </table>
            ...
            <div class="highlight">
                ...
                <?php if($qrCodePath): ?>
                    <div class="qr-container">
                        <img src="<?php echo e($message->embed($qrCodePath)); ?>" alt="QR Code for <?php echo e($professional->app_no); ?>">
                    </div>
                <?php endif; ?>

                <p>Application No: <strong><?php echo e($professional->app_no); ?></strong></p>
                <p>Default Password: <strong><?php echo e($defaultPassword); ?></strong></p>
            </div>
...
<?php /**PATH /var/www/html/CapstoneProject/resources/views/emails/professional-registered.blade.php ENDPATH**/ ?>