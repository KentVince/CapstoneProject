    ...
    <div class="mb-4 rounded-xl bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 p-4 space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <select id="farmFilter"
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getAllFarms(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $farm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const soilAnalysisData = <?php echo json_encode($this->getSoilAnalysisLocations(), 15, 512) ?>;
    const pestsList = <?php echo json_encode($this->getPestsList(), 15, 512) ?>;
    const diseasesList = <?php echo json_encode($this->getDiseasesList(), 15, 512) ?>;
    const allFarms = <?php echo json_encode($this->getAllFarms(), 15, 512) ?>;
