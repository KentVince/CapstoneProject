<div
    x-data="{ isOpen: <?php if ((object) ('isOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'->value()); ?>')<?php echo e('isOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'); ?>')<?php endif; ?>.live }"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.modal.index','data' => ['id' => 'change-password-modal','xModel' => 'isOpen','width' => 'md','@close' => 'isOpen = false; $wire.closeModal()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'change-password-modal','x-model' => 'isOpen','width' => 'md','@close' => 'isOpen = false; $wire.closeModal()']); ?>
...
<?php /**PATH /var/www/html/CapstoneProject/resources/views/livewire/change-password-modal.blade.php ENDPATH**/ ?>