...
<?php foreach($attributes->onlyProps(['style', 'display', 'fixed', 'position']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['style', 'display', 'fixed', 'position']); ?>
<?php foreach (array_filter((['style', 'display', 'fixed', 'position']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/CapstoneProject/vendor/stechstudio/filament-impersonate/resources/views/components/banner.blade.php ENDPATH**/ ?>