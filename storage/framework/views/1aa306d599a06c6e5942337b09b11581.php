...
<head>
    ...
    <style>
        ...
        .header { background: #16a34a; color: #fff; padding: 24px; text-align: center; }
        .header h1 { margin: 0; font-size: 24px; }
        .body { padding: 30px; }
        .info-table { width: 100%; border-collapse: collapse; margin: 20px 0; }
        .info-table td { padding: 10px 12px; border-bottom: 1px solid #eee; }
        .info-table td:first-child { font-weight: bold; color: #555; width: 40%; }
        .highlight { background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 6px; padding: 16px; margin: 20px 0; text-align: center; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Dear <strong><?php echo e($farmer->firstname); ?> <?php echo e($farmer->lastname); ?></strong>,</p>
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td><strong><?php echo e($farmer->app_no); ?></strong></td>
                </tr>
                <tr>
                    <td>Name</td>
                    <td><?php echo e($farmer->firstname); ?> <?php echo e($farmer->middlename); ?> <?php echo e($farmer->lastname); ?></td>
                </tr>
                <tr>
                    <td>Crop</td>
                    <td><?php echo e($farmer->crop ?? 'Coffee'); ?></td>
                </tr>
            </table>
            ...
            <div class="highlight">
                ...
                <?php if($qrCodePath): ?>
                    <div class="qr-container">
                        <img src="<?php echo e($message->embed($qrCodePath)); ?>" alt="QR Code for <?php echo e($farmer->app_no); ?>">
                    </div>
                <?php endif; ?>

                <p>Application No: <strong><?php echo e($farmer->app_no); ?></strong></p>
...
<?php /**PATH /var/www/html/CapstoneProject/resources/views/emails/farmer-registered.blade.php ENDPATH**/ ?>