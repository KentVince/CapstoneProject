...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg <?php echo e($borderClass($phStat)); ?>">
        ...
        <p class="text-sm font-semibold text-gray-900 dark:text-white">
            <?php echo e($phVal !== null ? number_format($phVal, 2) : 'N/A'); ?>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg <?php echo e($borderClass($omStat)); ?>">
        ...
        <p class="text-sm font-semibold text-gray-900 dark:text-white">
            <?php echo e($omVal !== null ? number_format($omVal, 2) . '%' : 'N/A'); ?>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg <?php echo e($borderClass($nStat)); ?>">
        ...
        <p class="text-sm font-semibold text-gray-900 dark:text-white">
            <?php echo e($nVal !== null ? number_format($nVal, 2) . '%' : 'N/A'); ?>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg <?php echo e($borderClass($pStat)); ?>">
        ...
        <p class="text-sm font-semibold text-gray-900 dark:text-white">
            <?php echo e($pVal !== null ? number_format($pVal, 2) . ' ppm' : 'N/A'); ?>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg <?php echo e($borderClass($kStat)); ?>">
        <div class="flex items-center justify-between mb-1">
        ...
        <p class="text-sm font-semibold text-gray-900 dark:text-white">
            <?php echo e($kVal !== null ? number_format($kVal, 2) . ' ppm' : 'N/A'); ?>
        ...
        <div class="md:col-span-2 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600 shadow-md">
            ...
            <div class="flex items-center justify-between bg-gray-700 dark:bg-gray-900 px-4 py-2">
                <div class="flex items-center gap-2 text-white text-xs font-medium">
                    ...
                    <span>Soil Analysis Report — <?php echo e($record->farm_name ?? 'Farm'); ?></span>
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <button
                        type="button"
                        onclick="
                            var viewer = document.getElementById('rec-viewer-<?php echo e($record->id); ?>');
                            var btn = document.getElementById('rec-expand-btn-<?php echo e($record->id); ?>');
                    ...
                    <button
                        type="button"
                        onclick="
                            var content = document.getElementById('rec-viewer-<?php echo e($record->id); ?>').innerText;
            ...
            <div class="bg-gray-700 dark:bg-gray-900 px-4 py-1 text-center text-xs text-gray-400">
                ...
                &nbsp;|&nbsp; Generated on:
                <span class="font-medium text-gray-200"><?php echo e($record->updated_at?->format('M d, Y') ?? 'N/A'); ?></span>
            </div>
                ...
                <!--[if BLOCK]><![endif]--><?php if($record->farmer_reply): ?>
                    <div class="flex justify-end">
                        <div class="max-w-[80%] bg-amber-100 dark:bg-amber-900/40 rounded-lg p-2.5">
                            ...
                            <p class="text-sm text-gray-900 dark:text-gray-100 leading-relaxed"><?php echo e($record->farmer_reply); ?></p>
                            <!--[if BLOCK]><![endif]--><?php if($record->farmer_reply_date): ?>
                                <span class="text-[10px] text-gray-500 dark:text-gray-400 mt-1 block text-right">
                                    <?php echo e($record->farmer_reply_date->format('M d, Y · h:i A')); ?>
