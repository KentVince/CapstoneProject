<div class="space-y-4 p-4" x-data="{ showLightbox: false }">
    ...
    <div class="flex flex-col md:flex-row gap-6 pt-2">
        ...
        <div class="flex-1 grid grid-cols-2 gap-3">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                ...
                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($record->confidence); ?>%</p>
            </div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($record->validation_status === 'disapproved' && $record->expert_comments): ?>
        <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-3 rounded-lg">
            ...
            <p class="mt-1 text-sm text-red-700 dark:text-red-300"><?php echo e($record->expert_comments); ?></p>
        </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

    
    <!--[if BLOCK]><![endif]--><?php if($record->validated_by): ?>
        <div class="text-xs text-gray-500 dark:text-gray-400 text-center">
            Validated by <span class="font-medium"><?php echo e($record->validator->name ?? 'Unknown'); ?></span>
            on <?php echo e($record->validated_at?->format('M d, Y \a\t h:i A')); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($record->image_path): ?>
        ...
        >
            ...
            <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/60 text-white px-4 py-2 rounded-lg text-sm">
                <?php echo e($record->pest); ?> - <?php echo e($record->confidence); ?>% confidence
            </div>
        </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div>
