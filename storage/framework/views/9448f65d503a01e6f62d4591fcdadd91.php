        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-lg text-gray-600"><?php echo e(auth()->user()->name); ?></p>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/CapstoneProject/resources/views/filament/pages/welcome.blade.php ENDPATH**/ ?>