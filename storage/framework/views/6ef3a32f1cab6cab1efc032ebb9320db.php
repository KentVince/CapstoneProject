    ...
    <div class="print-card mx-auto" style="width: 400px; border: 2px solid #16a34a; border-radius: 12px; overflow: hidden; font-family: Arial, sans-serif;">
        ...
        <div style="padding: 24px; text-align: center; background: white;">
            ...
            <div style="margin-top: 12px;">
                <p style="margin: 6px 0; font-size: 18px; font-weight: bold; color: #111;"><?php echo e($fullName); ?></p>
                <p style="margin: 6px 0; font-size: 14px; color: #555;">Application No: <strong style="color: #16a34a;"><?php echo e($appNo); ?></strong></p>
                <!--[if BLOCK]><![endif]--><?php if($rsbsaNo): ?>
                <p style="margin: 6px 0; font-size: 14px; color: #555;">RSBSA No: <strong style="color: #16a34a;"><?php echo e($rsbsaNo); ?></strong></p>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH /var/www/html/CapstoneProject/resources/views/components/farmer-print-card.blade.php ENDPATH**/ ?>